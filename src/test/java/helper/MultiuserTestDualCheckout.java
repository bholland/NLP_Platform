...
public class MultiuserTestDualCheckout {
    ...
    public void setUp() throws SQLException {
        ...
        port = "5432";
        database = "db_multiuser_dual_testing";
        user_name = "ben";
        password = "password";
    ...
    public void testTearDown() {
    	...
    	for (Integer user_id: keys) {
    		...
    		Integer document_id_comp = mCheckoutObjectComp.getUserDocuments().get(user_id);
    		assertTrue("document ids not checked out for the same user.", document_id == document_id_comp);
    	}
    }
    ...
    public void testDualDocumentCheckout() throws Throwable {
    	...
    	Thread.sleep(2000); //sleep is in ms. 
    	
    	response = DatabaseHelper.MultiuserCheckoutDocument(connection, user_id);
    	mCheckoutObjectComp.insertCheckedoutDocument(user_id, response.getDocumentId());
