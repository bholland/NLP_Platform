...
public class MultiuserTestZeroTimeout {
    ...
    public void setUp() throws SQLException {
        ...
        port = "5432";
        database = "db_multiuser_zero_testing";
        user_name = "ben";
        password = "password";
    ...
    public void testTearDown() {
    	...
    	assertTrue("document_count should only have a single entry.", document_count.size() == 1);
    	for (Integer x: document_count.keySet()) {
    		assertTrue("document_count should only have a single entry and all objects assigned to it.", document_count.get(x) == THREAD_COUNT);
    	}
    }
    ...
    public void testDocumentCheckoutNoTimeout() throws Throwable {
    	Connection connection = DriverManager.getConnection(database_connection, "ben", "password");
    	
        Statement s = connection.createStatement();
        String update_statement = "UPDATE projects SET checkout_timeout = 0;";
